...
(function (factory) {
  ...
  var editor = renderer.create('<div class="note-editor note-frame panel panel-default body"/>');
  var toolbar = renderer.create('<div class="note-toolbar panel-heading toolbar"/>');
